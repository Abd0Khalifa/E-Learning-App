...
import { faThLarge, faBook, faCalendar, faChartLine, faCertificate, faCommentAlt, faUser, faCog, faBars, faChalkboardTeacher, faUsers, faDollarSign } from "@fortawesome/free-solid-svg-icons";
            ...
            >
                <div className="p-6">
                    ...
                    <nav className="space-y-4">
                        <Link to={"/iDashboard"} className="nav-link flex items-center gap-3">
                            <FontAwesomeIcon icon={faThLarge} />
                            Dashboard
                        </Link>
                        <Link to={"/manageCourses"} className="nav-link flex items-center gap-3">
                            <FontAwesomeIcon icon={faChalkboardTeacher} />
                            My Courses
                        </Link>
                        <Link to={"/sProgress"} className="nav-link flex items-center gap-3">
                        ...
                        <Link to={"/iProfile"} className="nav-link flex items-center gap-3 text-main-color">
