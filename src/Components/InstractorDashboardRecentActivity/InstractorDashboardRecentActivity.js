import { faCertificate, faComment, faFilter, faUserGraduate } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">John Doe left a 5-star review on "Web Development Masterclass"</p>
        ...
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 rounded-full bg-main-color/20 flex items-center justify-center flex-shrink-0">
            <FontAwesomeIcon icon={faUserGraduate} className="text-main-color" />
          </div>
          <div>
            <h4 className="font-medium">New Enrollment</h4>
            <p className="text-gray-400 text-sm">5 new students enrolled in "AI & Machine Learning"</p>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">3 students completed "Digital Art & Design"</p>
